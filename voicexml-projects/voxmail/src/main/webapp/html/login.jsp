    ...
    <tr>
      <td>
        <table width="98%" border="0" cellspacing="0" cellpadding="0" align="left">
          ...
          <tr>
            <td><img name="home" border="0" src="html/images/dark.jpg" width="721" height="33"></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              <form method="POST" action="<%=request.getContextPath()%>/inbox.do" name="login">
                ...
                <table>
                  <tr>
                    <td><font color="#000000" face="verdana, sans-serif" size="1"> <%
                                        if (event != null) {
                                            out.println("<font color=\"#000000\">" + event + "</font><hr><br>");
                                        }
                                        %> <b>phone:</b>&nbsp;(no dashes)
                    </font><br> <input type="text" name="phone" size="17" value="" tabindex="1"> <br> <font
                      color="#000000" face="verdana, sans-serif" size="1"
                    ><b>pin:</b></font><br> <input name="pin" size="17" type="password" tabindex="2"> <br>
                      <input type="submit" value="logon" class="button" name="action"></td>
                  </tr>
                </table>
              </form>
            </td>
