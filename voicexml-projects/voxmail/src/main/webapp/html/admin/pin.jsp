...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td align="left" style="text-align: left; border: none">&nbsp;</td>
...
<br>
<h1><%=mailbox.getFirstName() + " " + mailbox.getLastName()%>&nbsp;::&nbsp;Setup
</h1>
<table>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>
      <form method="post" action="<%=request.getContextPath()%>/inbox.do">
        <input type="hidden" name="cmd" value="doPin"> <input type="hidden" name="mailboxId"
          value="<%=mailbox.getMailboxId()%>"
        >
        <table border="0">
          <% if (hasError) {%>
          <tr>
            <td colspan="2"><font color="red"> The pins below did not match. </font></td>
          </tr>
          <%}%>
          <tr>
            <td width="120">4 Digit Pin:</td>
          ...
          <tr>
            <td>IMAP Username</td>
            <td><input type="text" name="imapUsername" value="<%=mailbox.getImapUsername()%>"></td>
          </tr>
          <tr>
            <td>IMAP Password</td>
            <td><input type="text" name="imapPassword" value="<%=mailbox.getImapPassword()%>"></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
