...
/*
 * WebUtil.java Created on January 14, 2007, 12:27 PM
 */
...
public class WebUtil {
    ...
    public static boolean postToUrl(final String page) {
        URL url;
        ...
        try {
            ...
            String content = "name=" + URLEncoder.encode("test", "UTF-8") + "&email=" + URLEncoder.encode("test@email.com", "UTF-8");
