...
public class VoxmailException extends Exception {
     ...
     *            method.
     */
    public VoxmailException(final String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public VoxmailException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public VoxmailException(final Throwable cause) {
