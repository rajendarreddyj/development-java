...
public class InvalidMailboxException extends Exception {
     ...
     *            method.
     */
    public InvalidMailboxException(final String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public InvalidMailboxException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public InvalidMailboxException(final Throwable cause) {
