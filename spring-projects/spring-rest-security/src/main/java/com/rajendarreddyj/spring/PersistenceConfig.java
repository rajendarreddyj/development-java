...
@ComponentScan({ "com.rajendarreddyj.spring.persistence" })
// @ImportResource("classpath*:springDataPersistenceConfig.xml")
@EnableJpaRepositories(basePackages = "com.rajendarreddyj.spring.persistence.dao")
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan(new String[] { "com.rajendarreddyj.spring.persistence.model" });
