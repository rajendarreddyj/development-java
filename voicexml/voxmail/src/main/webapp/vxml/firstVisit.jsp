...
<vxml version="2.0" application="<%=request.getContextPath()%>/vxml/approot.jsp">
    ...
    <form id="Start">
        ...
        <prompt cond="playIntro">
            <audio expr="audioDir + 'Welcome.wav'">
                Welcome to the Vox e o voicemail system.
            </audio>
        </prompt>   
        <goto next="#FirstTimeIntro"/>
        </block>
    </form>
    
    <form id="FirstTimeIntro">
        <field name="choice" >
            <grammar src="grammars/FirstTimeOptions.xml" type="application/grammar-xml"/> 
            <prompt cond="playIntro">
                <audio expr="audioDir + 'ReviewGreeting-bad.wav'">
                    You can choose what greeting people will hear
                    when they reach your voicemail.  To review the standard
                    greeting, press 1.  To record only your name to play
                    with the standard greeting, press 2.  Or, to record a custom
                    greeting, press 3.
                </audio>
            </prompt>
            <prompt cond="!playIntro">
                <audio expr="audioDir + 'AllRightStartOver.wav'">
    ...
    <form id="ReviewStandard">
        <block name="ReviewBlock" >
            <prompt>
                <audio expr="audioDir + 'HeresStandardGreeting.wav'">
        ...
        <field name="choice" >
            ...
            <if cond="choice=='save'"> 
                ...
                <submit next="firstVisit.do" namelist="cmd greetingType mailboxId" method="post" enctype="multipart/form-data" fetchhint="safe"/>
        ...
        <field name="confirm">
            ...
            <filled>
                ...
                <if cond ="confirm =='save'">
                    ...
                    <submit next="firstVisit.do" namelist="recording cmd greetingType mailboxId" method="post" enctype="multipart/form-data" fetchhint="safe"/>
