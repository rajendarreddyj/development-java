 ...
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calc.jaxwswebservice.rajendarreddyj.com/", wsdlLocation = "http://localhost:8080/CalcWS/Calculator?wsdl")
public class CalculatorService extends Service {
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calc.jaxwswebservice.rajendarreddyj.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalcWS/Calculator?wsdl");
    ...
    public CalculatorService(final WebServiceFeature... features) {
        super(__getWsdlLocation(), CALCULATORSERVICE_QNAME, features);
    }

    public CalculatorService(final URL wsdlLocation) {
        super(wsdlLocation, CALCULATORSERVICE_QNAME);
    }

    public CalculatorService(final URL wsdlLocation, final WebServiceFeature... features) {
    ...
    public CalculatorService(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calc.jaxwswebservice.rajendarreddyj.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(final WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.jaxwswebservice.rajendarreddyj.com/", "CalculatorPort"), Calculator.class, features);
    }
