...
public class ODTProjectWithVelocityListController extends AbstractXDocReportWEBController {
    ...
    public InputStream getSourceStream() {
        return ODTProjectWithVelocityListController.class.getResourceAsStream("ODTProjectWithVelocityList.odt");
    }
